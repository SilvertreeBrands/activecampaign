        ...
        _connectAjax: function (self,params){
            ...
            $.ajax({
                ...
                if (response[fieldToCheck]) {
                    ...
                    if (response['ajax_url']) {
                        self.options.url = response['ajax_url'];
                    }

                    if (response['success_text']) {
                        self.options.successText = response['success_text'];
                    }

                    if (response['connection']) {
                        self.options.connection = response['connection'];
                    } else {
                        self.options.connection = false;
                    }
                }
            }).always(function () {
