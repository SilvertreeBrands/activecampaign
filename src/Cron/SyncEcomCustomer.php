...
class SyncEcomCustomer
{
    ...
    /**
     * @var \ActiveCampaign\Integration\Model\Sync\Processor\EcomCustomer
     */
    protected $processor;
     ...
     * @param \ActiveCampaign\Integration\Model\Sync\Processor\EcomCustomer $processor
     *
     */
    public function __construct(
        ...
        \ActiveCampaign\Integration\Model\Sync\Processor\EcomCustomer $processor
    ) {
        $this->helper = $helper;
            ...
            if ($this->helper->isActive()) {
                $collection = $this->collectionFactory->create()
                    ...
                    ->addFieldToFilter(
                        ...
                        ['eq' => \ActiveCampaign\Integration\Model\Source\AcEntityType::ECOM_CUSTOMER]
                    )
                    ->addFieldToFilter(
